...
MixSis::MixSis(MixSisCtrl *ctrls, const char* device, QObject *obj) : controls(ctrls), parent(obj)
{
    ...
    const char* should_name = (SND_LIB_VERSION >= 0x010107) ? "Keep Interface" : "Scarlett 6i6 USB-Sync Clock Source";
    if(strcmp("Scarlett 6i6 USB-Sync", name) && strcmp(should_name,name)){
